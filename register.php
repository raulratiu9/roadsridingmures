...
<head>
  ...
  <script>
    ...
    <title>Roads Riding Mureș - Register</title>
...
<body>
  ...
  <nav>
    ...
    <ul>
      <div class="languages">
        <a href="register.php?lang=ro">
          <img class="ro" src="images/ro.png">
        </a>
        <a href="register.php?lang=en">
    ...
    <aside>
    	<?php if(isset($_GET['error'])) {
    		if($_GET['error'] == 'emptyfields') {
              ...
              echo "<p class='error'>Invalid username or e-mail!</p>";
            }
            ...
            else if($_GET['error'] == "cpassword"){
              echo "<p class='error'>Your password doesn't match!</p>";
            }
            else if($_GET['error'] == "usertaken"){
              echo "<p class='error'>Username has already taken!</p>";
            }
            else if($_GET['error'] == "mailtaken"){
              echo "<p class='error'>E-mail has already taken!</p>";
            }
        }
        if(isset($_GET['register'])) {
        	if($_GET['register'] == 'succes') {
        		echo "<p class='succes'>You are registered with succes!</p>";
        	}
        } ?>
        <div class="register-box">
          <h1 class="register">
        	...
        	<form action="php/register-form.php" method="POST" enctype="multipart/form-data">
        		<div class="textbox">
