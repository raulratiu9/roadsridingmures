...
<head>
  ...
  <script>
    ...
    <title>Roads Riding Mureș - Update</title>
...
<body>
  ...
  <nav>
    ...
    <ul>
      <div class="languages">
        <a href="update.php?lang=ro">
          <img class="ro" src="images/ro.png">
        </a>
        <a href="update.php?lang=en">
  ...
  <div class="container">
    ...
    <div class="posts">
      ...
      foreach ($rows as $row) {
        ...
        <article class="post">
          ...
          <div class="post-meta">
            ...
            <span class="post-comments">
              ...
              <?php $conn = mysqli_connect("localhost", "00252698_rrm", "324681Taxi.", "00252698_rrm");
        ...
        <ins class="adsbygoogle"
                 style="display:block"
                 data-ad-client="ca-pub-4809817712279740"
                 data-ad-slot="5500594769"
                 data-ad-format="auto"
    ...
    <aside>
      ...
      <div class="login-box">
        ...
        <p>"; ?>
        <?php if ($_GET['lang'] == 'en') {
          echo "Have you not an account yet? Register now!";
        } else {
          echo "Nu ai un cont încă? Înregistrează-te acum!";
        }
        echo "</p>
        </font>
        </a>
                ...
                if (isset($_SESSION['username'])) {
                  ...
                  if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                      echo "<a href='update.php'><img class='avatar' src='" . $row['avatar'] . "'></a>";
                    }
                  }
                  if ($_GET['lang'] == 'en') {
                    ...
                    <button class='update' type='submit' name='update' value='Update'>
                      <?php if ($_GET['lang'] == 'en') {
                        echo "Update profile picture";
                      } else {
                        echo "Actualizează poza de profil";
                      } 
                      echo "</button>
                      </form>";
                      if(isset($_POST['update'])) {
                        if(isset($_FILES['avatar'])) {
                          ...
                          $update = mysqli_query($conn, "UPDATE users set avatar='$target_dir$file_name' WHERE id='$id' ");
                          if($update) {
                            echo "<p class='loggedin'>You have successfully updated the profile picture! You have to refresh the page!</p>";
                          } else {
                            echo "<p class='error'>Your profile picture could not be updated!</p>";
                          }
                        }
                      }
                    }
